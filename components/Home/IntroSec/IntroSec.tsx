...
function IntroSec() {
  return (
    ...
    >
      <FadeDown variant="div" delay={4} className="text-center mb-8">
      ...
      <VelocityScroll
        ...
        text="Rishabh Gokhe"
      />
      <FadeDown variant="div" delay={4.5} className="relative flex flex-col items-center mb-8">
        <p className="text-md md:text-xl max-w-[90vw] md:max-w-[60vw] text-center text-white">
          {introPara}
        </p>
      </FadeDown>
      <FadeRight variant="div" delay={4.7} className="flex justify-center items-center space-x-4">
        <CustomLinkButton
          download
