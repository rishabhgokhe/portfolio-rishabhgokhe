...
export default function Footer() {
  ...
  const footerLinks = orderedTitles
    ...
    .filter((item): item is { title: string; link: string } => Boolean(item.link));
          ...
          <div>
            ...
            <div className="mt-4 max-w-2xl font-mono text-xs leading-relaxed text-zinc-400 sm:text-sm">
              ...
              <div className="mb-1 pl-6">
                ...
                <span className="text-amber-200">&quot;Rishabh Gokhe&quot;</span>,
              </div>
              <div className="mb-1 pl-6">
              ...
              <div className="pl-6">
                <span className="text-sky-300">currentStatus:</span>{" "}
                <span className="text-amber-200">
          ...
          {footerLinks.map((item, index) => (
            <React.Fragment key={item.title}>
              <a
                ...
                rel={item.link.startsWith("mailto:") || item.link.startsWith("tel:") ? undefined : "noreferrer"}
