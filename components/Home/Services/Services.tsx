  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[minmax(0,1.08fr)_minmax(340px,0.92fr)] md:gap-10">
          ...
          <div className="services-right-column p-4 sm:p-6">
            ...
            <div className="services-right-reveal relative min-h-[420px] overflow-hidden rounded-xl border border-cyan-500/20 bg-zinc-950/65">
